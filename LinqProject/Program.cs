    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product> { 
                ...
                UnitPrice = 8000,
                UnitInStock=3},
                new Product{ProductId=1,CategoryId=1,ProductName = "Hp Laptop",
                QuantityPerUnit="8 GB Ram",
                UnitPrice = 6000,
                UnitInStock=2},
                new Product{ProductId=1,CategoryId=1,ProductName = "Samsung Telefon",
                QuantityPerUnit="4 GB Ram",
                UnitPrice = 5000,
                UnitInStock=15},
                new Product{ProductId=1,CategoryId=1,ProductName = "Apple Telefon",
                QuantityPerUnit="4 GB Ram",
                UnitPrice = 8000,
                UnitInStock=0}
        ...
        {
            return products.Where(p => p.UnitPrice > 5000
